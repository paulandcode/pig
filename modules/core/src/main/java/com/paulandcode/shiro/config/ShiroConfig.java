...
import com.paulandcode.shiro.dao.CustomSessionDao;
import com.paulandcode.shiro.realm.CustomRealm;
...
//        SecurityUtils.setSecurityManager(securityManager)
        ...
        //              (对应关系为: PUT<==>update, POST<==>create, GET<==>read, DELETE<==>delete)(其他方式见官网)
        //              例: /user/** = rest[user]
        ...
        //              指定请求端口号, 非指定端口号, 则会自动跳转到指定端口号, 例: /test= port[8081]
     ...
     */
    @Bean
    public DefaultWebSecurityManager securityManager(CustomRealm customRealm, EhCacheManager ehCacheManager, DefaultWebSessionManager sessionManager, CookieRememberMeManager cookieRememberMeManager) {
     ...
     */
    @Bean
    public DefaultWebSessionManager sessionManager(QuartzSessionValidationScheduler sessionValidationScheduler, CustomSessionDao customSessionDao, SimpleCookie sessionIdCookie) {
     ...
     * @return com.paulandcode.shiro.realm.CustomRealm
     */
    @Bean
     ...
     * @return com.paulandcode.shiro.credential.RetryLimitCredentialsMatcher
     */
    @Bean
